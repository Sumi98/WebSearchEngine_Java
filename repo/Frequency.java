...
public class Frequency {
	...
	public Frequency(int documentId, double frequency, double docLength) {
	...
	public Frequency(int documentId, double docLength) {
		this.documentId = documentId;
		this.frequency = 0;
		this.docLength = docLength;
		this.termFrequency = this.frequency / this.docLength;
	...
	public void add_Occurence(double noOfOccurences) {
	...
	public double get_Term_Frequency() {
